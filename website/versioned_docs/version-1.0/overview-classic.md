---
id: version-1.0-overview-classic
title: Overview
...
For more information including a history of the design decisions taken here, see the [Aventus Classic White Paper](#TODOaddproperlinkoncelive)
...
> Note: for more info on what is meant by some of these terms (eventOwner, ticketOwner, eventTime), see the [guides](/aventus-docs/aventus-classic)
